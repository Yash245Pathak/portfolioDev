    ...
    return (
        <>
            <div id='skill' className='flex flex-col px-5 md:px-10 mt-20'>
                <h1 className='text-[38px] font-bold'>Skills</h1>
                <div className='mt-20 grid grid-rows-4 md:grid-rows-2  grid-flow-col gap-10'>
                    {skill.map((skill) => {
                        return (
                            <div className='flex gap-2 justify-center items-center max-w-max'>
                                <span className='text-[50px] md:text-[80px]'>{skill.icon}</span>
